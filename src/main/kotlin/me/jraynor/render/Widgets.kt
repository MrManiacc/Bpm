...
object Widgets {
    ...
    private val iconRenderers: MutableMap<PinType, IconRenderers> = hashMapOf(
        Pair(PinType.GRID, this::gridIcon),
        Pair(PinType.SQUARE, this::squareIcon),
        Pair(PinType.ROUND_SQUARE, this::roundedSquareIcon),
        Pair(PinType.FLOW, this::flowIcon)
    )
